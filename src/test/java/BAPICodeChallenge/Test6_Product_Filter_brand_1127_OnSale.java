...
public class Test6_Product_Filter_brand_1127_OnSale {
    ...
    public void CompareProductVsFilterCount() {
        ...
        System.out.println("Products: total number of products which are on sale for Brand ID 1127 is: " + total);
        ...
        System.out.println("Filters: total number of products which are on sale for Brand ID 1127 is: " + filter_total);
